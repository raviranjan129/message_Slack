...
import { addChannelToWorkspaceSchema, createWorkspaceSchema } from '../../validators/workspaceSchema.js';
...
router.put('/:workspaceId/members',isAuthenticated,validate(addChannelToWorkspaceSchema),addMemberToWorkspaceController);
