    ...
    return(
            ...
            onComplete={handleAddMemberToWorkspace}
                ...
                classNames={{
                    ...
                    character:'h-auto rounded-md border flex items-center justify-center text-lg font-medium  border-gray-300 focus:outline-none focus:border-blue-500 focus:ring-1 focus:ring-blue-500',
